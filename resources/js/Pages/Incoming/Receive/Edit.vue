        ...
        <form @submit.prevent="submit" class="max-w-2xl space-y-4 rounded-xl border border-borderline bg-surface p-5">
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input :aria-label="t('incoming.tag')" v-model="form.tag" type="text" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary" />
                ...
                <div>
                    ...
                    <input :aria-label="t('incoming.qty')" v-model="form.qty" type="number" step="0.0001" min="0" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary" />
                ...
                <div>
                    ...
                    <input :aria-label="t('incoming.bundleQty')" v-model="form.bundle_qty" type="number" step="0.0001" min="0" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary" />
                </div>
                <div>
                    <label class="text-xs font-semibold text-ink-secondary">{{ t('incoming.bundleUnit') }}</label>
                    <select :aria-label="t('incoming.bundleUnit')" v-model="form.bundle_unit" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary">
                ...
                <div v-if="weightBasis">
                    ...
                    <input :aria-label="t('incoming.netUnit', { unit: weightUnit() })" v-model="form.net_weight" type="number" step="0.0001" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary" />
                ...
                <div v-if="weightBasis">
                    ...
                    <input :aria-label="t('incoming.grossUnit', { unit: weightUnit() })" v-model="form.gross_weight" type="number" step="0.0001" class="mt-1 w-full rounded-lg border-borderline bg-surface px-3 py-2 text-sm text-ink-primary focus:border-primary focus:ring-primary" />
                </div>
            </div>
