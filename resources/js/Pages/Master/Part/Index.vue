    ...
    <AppLayout>
        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <div v-if="perms.create" class="relative">
                <button @click="toggleNewMenu" class="inline-flex items-center gap-1 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 focus-visible:ring-offset-surface">
                    + {{ t('master.newPart') }}
                ...
                <div v-if="newMenuOpen" class="absolute right-0 z-10 mt-2 w-56 overflow-hidden rounded-lg border border-borderline bg-surface shadow-lg">
                    <Link
                        ...
                        class="flex items-center justify-between px-4 py-2.5 text-sm text-ink-primary transition hover:bg-primary-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 focus-visible:ring-offset-surface"
                    >
